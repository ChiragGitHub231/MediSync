<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Admin/Admin.master" AutoEventWireup="true" CodeBehind="UpdateDoctor.aspx.cs" Inherits="HCRS_Client.Pages.Admin.UpdateDoctor" %>

<asp:Content ID="UpdateDoctorHeader" ContentPlaceHolderID="head" runat="server">
</asp:Content>

<asp:Content ID="UpdateDoctorContent" ContentPlaceHolderID="AdminMasterPage" runat="server">
    <div class="container">
