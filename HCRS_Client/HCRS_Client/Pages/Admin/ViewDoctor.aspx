<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Admin/Admin.master" AutoEventWireup="true" CodeBehind="ViewDoctor.aspx.cs" Inherits="HCRS_Client.Pages.Admin.ViewDoctor" %>

<asp:Content ID="ViewDoctorHeader" ContentPlaceHolderID="head" runat="server">
</asp:Content>

<asp:Content ID="ViewDoctorContent" ContentPlaceHolderID="AdminMasterPage" runat="server">
    <div class="container">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input runat="server" type="text" id="txtSpecialization" class="form-control" placeholder="Enter specialization" required="required"
                                oninvalid="this.setCustomValidity('Please enter your specialization')" oninput="this.setCustomValidity('')" disabled="disabled" />
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input runat="server" type="number" id="txtExperience" class="form-control" placeholder="Enter experience" required="required"
                                oninvalid="this.setCustomValidity('Please enter your experience')" oninput="this.setCustomValidity('')" disabled="disabled" />
                        </div>
                    </div>
