<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Admin/Admin.master" AutoEventWireup="true" CodeBehind="UpdatePatient.aspx.cs" Inherits="HCRS_Client.Pages.Admin.UpdatePatient" %>

<asp:Content ID="UpdatePatientHeader" ContentPlaceHolderID="head" runat="server">
</asp:Content>

<asp:Content ID="UpdatePatientContent" ContentPlaceHolderID="AdminMasterPage" runat="server">
    <div class="container">
                ...
                <form runat="server">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            ...
                            -->
                            <asp:TextBox runat="server" ID="txtDOB1" type="date" CssClass="form-control" placeholder="Select date" required="required"
                            oninvalid="this.setCustomValidity('Please select date')" oninput="this.setCustomValidity('')" AutoPostBack="True" OnTextChanged="txtDOB_TextChanged"></asp:TextBox>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input runat="server" type="text" id="txtAge" class="form-control" placeholder="Your age" required="required"
