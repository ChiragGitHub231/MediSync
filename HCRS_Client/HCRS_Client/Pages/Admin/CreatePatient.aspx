<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Admin/Admin.master" AutoEventWireup="true" CodeBehind="CreatePatient.aspx.cs" Inherits="HCRS_Client.Pages.Admin.CreatePatient" %>

<asp:Content ID="CreatePatientHeader" ContentPlaceHolderID="head" runat="server">
</asp:Content>

<asp:Content ID="CreatePatientContent" ContentPlaceHolderID="AdminMasterPage" runat="server">
    <div class="container">
